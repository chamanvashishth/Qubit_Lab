...
export const CURRICULUM_TOPICS: CurriculumTopic[] = [
  // 1. Foundations
  {
    ...
    durationMin: 15,
    iconName: 'Cpu',
    description: 'Explore the fundamental paradigm shift from silicon transitors manipulating deterministic bits (0 or 1) to quantum systems leveraging quantum mechanical wavefunctions.',
    learningObjectives: [
      'Understand the difference between Boolean states and Hilbert space state vectors',
      'Learn why Moore\'s Law is hitting atomic quantum limits',
  ...
  // 2. Core Concepts
  {
    ...
    durationMin: 25,
    iconName: 'Sparkles',
    description: 'Understand how quantum systems do not choose between 0 and 1 until measured, but rather interfere constructively and destructively as probability waves.',
    learningObjectives: [
  ...
  },
  {
    ...
    tagline: 'Spooky action and non-separable tensor states',
    difficulty: 'Intermediate',
    durationMin: 30,
    iconName: 'Network',
  ...
  // 6. Quantum Algorithms
  {
    ...
    tagline: 'Exponential speedup over classical oracle queries',
    difficulty: 'Intermediate',
    durationMin: 35,
    iconName: 'Activity',
    description: 'Examine the historic algorithm that proved quantum computers can solve a problem in a single query that requires 2^(n-1) + 1 classical queries: determining if a function is constant or balanced.',
    learningObjectives: [
  ...
  },
  {
    ...
    tagline: 'Polynomial-time integer factorization breaking RSA',
    difficulty: 'Advanced',
    durationMin: 50,
    iconName: 'ShieldAlert',
    description: 'Explore how Shor\'s algorithm reduces the integer factorization problem N = p*q to order-finding f(x) = a^x mod N, solved exponentially faster using the Quantum Fourier Transform.',
    learningObjectives: [
  ...
  // 7. Programming Sandbox
  {
    ...
    tagline: 'Write, transpile, and execute in Qiskit, PennyLane, and Cirq',
    difficulty: 'Intermediate',
    durationMin: 30,
    iconName: 'Terminal',
    description: 'Hands-on programming IDE for writing authentic quantum software in Qiskit, PennyLane, and Cirq, running simulation backends, and debugging with AI assistance.',
    learningObjectives: [
      'Write multi-qubit circuits across Qiskit Aer, PennyLane, and Cirq SDKs',
      'Execute statevector simulations and sample measurement histograms',
      'Export circuits to OpenQASM 2.0 and Python files',
    ],
    prerequisites: ['Single-Qubit Quantum Gates'],
  },
];
